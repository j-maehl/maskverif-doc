...
module Mult = {
  ...
  proc refresh_r (a1,a2,a3,a4,a5,a6,a7) = {
    var r1, r2, r3, r4, r5, r6, r7;
    var i1_1,i2_1,i3_1,i4_1,i5_1,i6_1,i7_1,
        i1_2,i2_2,i3_2,i4_2,i5_2,i6_2,i7_2,
        i1_3,i2_3,i3_3,i4_3,i5_3,i6_3,i7_3,
        i1_4,i2_4,i3_4,i4_4,i5_4,i6_4,i7_4,
        i1_5,i2_5,i3_5,i4_5,i5_5,i6_5,i7_5: byte;

    r1 = $ distr; r2 = $ distr; r3 = $distr; r4 = $distr; r5 = $distr; r6 = $distr; r7 = $distr;


    (i1_2,i2_2,i3_2,i4_2,i5_2,i6_2,i7_2) = (r1,r2,r3,r4,r5,r6,r7);
    (i1_3,i2_3,i3_3,i4_3,i5_3,i6_3,i7_3) = (r7,r1,r2,r3,r4,r5,r6);
                     
    (i1_4,i2_4,i3_4,i4_4,i5_4,i6_4,i7_4) = (a1+i1_2, a2+i2_2, a3+i3_2, a4+i4_2, a5+i5_2, a6+i6_2, a7 + i7_2);
    (i1_5,i2_5,i3_5,i4_5,i5_5,i6_5,i7_5) = (i1_4+i1_3, i2_4+i2_3, i3_4+i3_3, i4_4+i4_3,i5_4+i5_3, i6_4+i6_3, i7_4 + i7_3);

    return (i1_5, i2_5, i3_5, i4_5, i5_5, i6_5, i7_5);
  }
  ...
  proc square (a) = {
   var a1, a2, a3, a4, a5, a6, a7, b1, b2, b3, b4, b5, b6, b7, c1, c2, c3, c4, c5, c6, c7;
    ...
    (b1,b2,b3,b4,b5,b6,b7) = refresh_r(a1,a2,a3,a4,a5,a6,a7);
    (a1,a2,a3,a4,a5,a6,a7) = refresh_r(a1,a2,a3,a4,a5,a6,a7);
    (c1,c2,c3,c4,c5,c6,c7) = mult_r(a1,a2,a3,a4,a5,a6,a7,b1,b2,b3,b4,b5,b6,b7);
    return (c1 + c2 + c3 + c4 + c5 + c6 + c7);
  }

  proc rmult_r(a1, a2, a3, a4, a5,a6,a7, b1, b2, b3, b4, b5,b6,b7: byte) = {
    var c1, c2, c3, c4, c5, c6, c7;

    (c1,c2,c3,c4,c5,c6,c7) = mult_r(a1,a2,a3,a4,a5,a6,a7,b1,b2,b3,b4,b5,b6,b7);
    (c1,c2,c3,c4,c5,c6,c7) = refresh_r(c1,c2,c3,c4,c5,c6,c7);

    return (c1,c2,c3,c4,c5,c6,c7);
  }

  proc multr_r(a1,a2,a3,a4,a5,a6,a7,b1,b2,b3,b4,b5,b6,b7: byte) = {
    var c1, c2, c3, c4, c5, c6, c7;

    (b1,b2,b3,b4,b5,b6,b7) = refresh_r(b1,b2,b3,b4,b5,b6,b7);
    (c1,c2,c3,c4,c5,c6,c7) = mult_r(a1,a2,a3,a4,a5,a6,a7,b1,b2,b3,b4,b5,b6,b7);

    return (c1,c2,c3,c4,c5,c6,c7);
  }

  proc multrr_r(a1,a2,a3,a4,a5,a6,a7,b1,b2,b3,b4,b5,b6,b7: byte) = {
    var c1, c2, c3, c4, c5, c6, c7;
  ...
  proc refresh2_r(a1, a2, a3, a4, a5, a6,a7: byte) = {
    var c1, c2, c3, c4, c5, c6,c7;
    (c1,c2,c3,c4,c5,c6,c7) = refresh_r(a1, a2, a3, a4, a5, a6,a7);
    (c1,c2,c3,c4,c5,c6,c7) = refresh_r(c1,c2,c3,c4,c5,c6,c7);
