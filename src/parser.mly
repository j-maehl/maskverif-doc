%{
  ...
  let dfl_ty ty = 
    ...
    | Some ty -> ty 
%}
%token PROC END PUBLIC INPUTS OUTPUTS SHARES RANDOMS OTHERS OPERATOR BIJ ARROW
%token <string>SNI NI PROBING PRINT STRING
...
func:
  | PROC f_name=ident COLON
      ...
      f_cmd    = cmd
    END
    { { f_name; f_pin; f_in; f_out; f_shares; f_rand; f_other; f_cmd } }
